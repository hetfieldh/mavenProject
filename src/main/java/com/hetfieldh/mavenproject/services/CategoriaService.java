...
import com.hetfieldh.mavenproject.services.exceptions.DataIntegrityException;
...
public class CategoriaService {
	...
	public void delete(Integer id) {
		...
		try {
			...
			throw new DataIntegrityException("Não é possível excluir uma categoria que contém produtos cadastrados.");
		}
	}
}